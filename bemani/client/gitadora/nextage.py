...
class GitadoraNextageClient(BaseClient):
    ...
    def verify_nextage_shopinfo_regist(self) -> str:
        call = self.call_node()
        ...
        shop.add_child(Node.string("name", "TEST"))
        shop.add_child(Node.s8("pref", 1))
        shop.add_child(Node.string("systemid", "01000027584F6D3A"))
        shop.add_child(Node.string("hardwareid", "0100DEADBEEF"))
        shop.add_child(Node.string("locationid", "63"))
        # testmode
        ...
        coin_option.add_child(Node.s32("coin_slot", 0))
        ...
        tax.add_child(Node.s32("tax_plase", 2))
        ...
        return str("Verify Nextage Shopinfo Regist Done!")

    def verify_nextage_gameinfo_get(self) -> str:
        call = self.call_node()
